...
/* weightMatrix[6][21] is weights gradient matrix, which was calculated by "4. Model_Trainning.m".
* biasMatrix[6] is bias gradient vector, which was also calculated by "4. Model_Trainning.m".
* Further information about Model Training is available at 
* "Magic-Music-Player/Software/Hand Gesture Recognition/Software Used in Database Establishment/4. Classification/"
* predictResult[6] = w * A + b, where A is data of tested gesture.
* predictResult  |   classificationResult   |   Gesture
* ---------------+--------------------------+------------
*       [0]      |             1            |   Forward
*       [1]      |             2            |  Backward
*       [2]      |             3            |    Left
